...
const Projects = () => {
  return (
    <div className="bg-gray-800 text-white py-20" id="project">
      <div className="container mx-auto px-8 md:px-16 lg:px-24">
        <h2 className="text-4xl font-bold text-center mb-12">My Projects</h2>
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          {projects.map((project) => (
            <div key={project.id} className="bg-gray-700 p-6 border border-gray-600 shadow rounded-lg hover:shadow-lg 
            transform transition-transform duration-300 hover:scale-105">
              ...
              <PrimaryButton href={project.github}>GitHub</PrimaryButton>
            </div>
          ))}
        </div>
      </div>
